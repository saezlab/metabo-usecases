# Table 3 — Resource × record-type coverage (FR-015a)

**Mode**: pipeline (FR-015a)

**Deployment**: `dev3` (default for `tab03-record-coverage`) + `dev4`
...
- `out/` — generated artifacts:
  - `tab03-record-coverage.pdf` — typeset table (xelatex).
  - `tab03-record-coverage.csv` — wide-format CSV (FR-026).
  - `tab03-record-coverage-with-caption.pdf` — table + caption (FR-041).
  - `caption.txt` — plain-text caption (FR-041a).
  - `tab03-record-coverage.pdf.provenance.json` — sidecar (FR-031,
