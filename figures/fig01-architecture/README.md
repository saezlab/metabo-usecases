# Figure 1 — Architecture diagram + statistics digest
...
- `out/fig01-architecture.pdf` — verbatim copy of the vendored Inkscape PDF.
- `out/fig01-architecture.svg` — verbatim copy of the vendored Inkscape SVG.
- `out/fig01-architecture-with-caption.pdf` — typeset caption-and-figure PDF
  (FR-041).
- `out/caption.txt` — plain-text caption (FR-041a).
- `out/fig01-architecture.pdf.provenance.json` — sidecar carrying the dev5
