...
- `out/fig02-overview.{pdf,svg}` — bare composite (Panel A vendored
...
- `out/fig02-overview-with-caption.pdf` — composite + typeset
  caption (xelatex + `tex/caption.sty`, FR-041).
- `out/caption.txt` — plain-text caption (deterministic strip,
  FR-041a).
- `out/fig02-overview.pdf.provenance.json` — sidecar.
