# metalinks-versions — MetaLinksDB resource comparison
...
- `out/metalinks-versions.{pdf,svg}` — five-panel composite
- `out/metalinks-versions.pdf.provenance.json` — provenance
