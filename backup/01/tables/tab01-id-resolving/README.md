# Table 1 — Identifier resolving across integrated resources

**Mode**: pipeline (FR-014, Methods table)

**Deployment**: `dev3` (default for `tab01-id-resolving` — see
...
- `out/` — generated artifacts:
  - `tab01-id-resolving.pdf` — typeset table (xelatex via gt LaTeX).
  - `tab01-id-resolving.csv` — wide-format CSV (FR-026).
  - `tab01-id-resolving-with-caption.pdf` — table + caption (FR-041).
  - `caption.txt` — plain-text caption (FR-041a).
  - `tab01-id-resolving.pdf.provenance.json` — sidecar (FR-031).
