# Table 2 — RaMP InChIKey conflicts (structure-based identifier comparison)

**Mode**: pipeline (FR-015, Methods table)

**Deployment**: `dev4` (default for `tab02-ramp-comparison` — see
...
- `out/` — generated artifacts:
  - `tab02-ramp-comparison.pdf` — typeset table (xelatex via gt LaTeX).
  - `tab02-ramp-comparison.csv` — wide-format CSV (FR-026).
  - `tab02-ramp-comparison-with-caption.pdf` — table + caption (FR-041).
  - `caption.txt` — plain-text caption (FR-041a).
  - `tab02-ramp-comparison.pdf.provenance.json` — sidecar (FR-031).
