...
#' write_sidecar(
#'     artifact_id   = "database-content/panelB",
#'     artifact_path = "figures/database-content/out/panelB.pdf",
...
#'     artifact_path = "figures/database-content/out/database-content.pdf",
