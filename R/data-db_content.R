...
#' @export
entities_by_resource <- function(panel_id = "fig01-overview") {
...
#' @importFrom DBI dbGetQuery
#' @export
interactions_by_resource <- function(panel_id = "fig01-overview") {
...
#' @importFrom DBI dbGetQuery
#' @export
interactions_by_type <- function(panel_id = "fig01-overview") {
...
#' @importFrom DBI dbGetQuery
#' @export
associations_by_resource <- function(panel_id = "fig01-overview") {
...
#' @importFrom DBI dbGetQuery
#' @export
ontology_terms_by_ontology <- function(panel_id = "fig01-overview",
                                       top_n = 10L) {
